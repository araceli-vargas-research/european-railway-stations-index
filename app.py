...
with about_right:
    st.markdown(
        '''<div class="rail-accordion">
          ...
          <details><summary>Are all figures from calendar year 2026?</summary><p>No. The working 2026 sheet includes current 2026 delay and wait observations, while passenger volume uses the latest full-year figure available for the 2026 index.</p></details>
